...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 27 15:38:24 2024
...
plt.switch_backend('qtAgg') #maybe comment out

#open up database to access DLCF RGB composite
home_dir = '/Users/ainsleyg/Documents/python/CISSES/2020_daily_DLCF_RGB_composites_no_ref_QC_no_cldshadow_QC_keep_landwatermask_1_3_4_cldmsk_keep_probclear_clear_fix_bowtie_del_age_quality_flag.h5'
databse_name = '2020_daily_DLCF_RGB_composites_no_ref_QC_no_cldshadow_QC_keep_landwatermask_1_3_4_cldmsk_keep_probclear_clear_fix_bowtie_del_age_quality_flag.h5'

with h5py.File(home_dir + databse_name, 'r') as hf_database:
    X = hf_database['08.10.2020'][:] #pick any day in database (every 2 weeks)
...
burnscar_semi_labeled_dataset_file = '/Users/ainsleyg/Documents/python/CISSES/2020_daily_DLCF_RGB_composites_no_ref_QC_no_cldshadow_QC_keep_landwatermask_1_3_4_cldmsk_keep_probclear_clear_fix_bowtie_del_age_quality_flag.h5' # add file path
...
if plot==True:
   ...
   # ax[1].set_title('Day Land Cloud Fire RGB\nManual Labels\nPrimitive Burn Scar Mask')
    ...
    f.suptitle('NOAA-20 VIIRS Valid 08.10.2020 Composited & Cloud-Cleared Over Previous 8 Days') #change date or make data variable
