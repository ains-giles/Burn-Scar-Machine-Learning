...
'''
# X is the input data for training, validation and testing
X = None
# y is the labels for X in the one-hot vector style of 1 for burned and 0 for unburned
y = None
...
'''
unet_cnn_model.fit(X_train, y_train, validation_data=(X_val,y_val), batch_size=16, epochs=25, callbacks=callbacks)
